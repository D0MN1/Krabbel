-- Krabbel Azure MySQL Setup Script
-- Create application user and grant permissions
CREATE USER 'krabbel_user'@'%' IDENTIFIED BY 'HM]{yQ8k7hrt-0F25$-y/PF}';
GRANT SELECT, INSERT, UPDATE, DELETE ON krabbel_db.* TO 'krabbel_user'@'%';
FLUSH PRIVILEGES;

-- Initial Schema for Krabbel Application (copy from Flyway migration)
-- Users table
...
-- Note: After deployment, you should change these default passwords!
